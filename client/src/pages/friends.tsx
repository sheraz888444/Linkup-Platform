        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-slate-200 dark:border-zinc-700 p-6">
              <h1 className="text-2xl font-bold text-slate-900 dark:text-zinc-100 mb-2">Friends</h1>
              <p className="text-slate-600 dark:text-zinc-300">
                See your friends and connection suggestions. Friend management coming soon.
              </p>
